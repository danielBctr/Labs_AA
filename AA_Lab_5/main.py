...
# Generate a dense graph with 5 nodes and 7 edges
dense_graph = generate_complete_graph(5)
draw_graph(dense_graph, 'Dense Graph')

# Generate a sparse graph with 5 nodes and 0.3 edge density
sparse_graph = generate_sparse_graph(5, 0.3)
...
plt.bar(x-0.1, times_dj[3][0:5], 0.2, label='Sparse 100', color='blue')
plt.bar(x+0.2, times_dj[2][5:10], 0.2, label='Dense 50', color='yellow')
...
plt.bar(x+0.2, times_floyd[2][5:10], 0.2, label='Dense 50', color='yellow')
